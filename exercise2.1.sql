...
---1.Who Were were admitted in the month of January
...
--- 2. the female patients who are not suffering from asthma
...
---4. Display patient_id, patient_name, doctor_id, doctor_name, room_no, room_type, admission_date
